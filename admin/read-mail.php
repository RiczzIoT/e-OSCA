...
// Pag Fetch ng current sa settings gar
...
// Fetch the user's details for message
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body p-0">
                            <div class="mailbox-read-info">
                                ...
                                <h6>From: <?php echo htmlspecialchars($message['email']); ?>
                                    <span class="mailbox-read-time float-right"><?php echo htmlspecialchars($message['timestamp']); ?></span></h6>
                            </div>
                            <!-- /.mailbox-read-info -->
