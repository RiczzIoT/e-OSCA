...
$sms_message = "Hello, $full_name. This is a reminder that your monthly pension of PHP $monthly_pension is ready for pickup on $formatted_date at $formatted_time. Your Ticket Number: $queue_number. $custom_message";
